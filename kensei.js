...
Kensei.app = (function () {
    ...
    function renderIndex() {
        ...
        posts.forEach(function (post) {
            Kensei.DOM.renderDefaultPostIndex(options.container, post);
        });
    ...
    function renderPost() {
        Kensei.loader.ajaxGet('/posts/'+ params.postId + '.md', function (response) {
            Kensei.DOM.renderString(options.container, converter.makeHtml(response));
    ...
    function renderDisqus() {
        ...
        Kensei.DOM.renderString(options.container, '<div id="disqus_thread"></div>');
        ...
        Kensei.loader.requireJS('//' + options.disqus.disqusId + '.disqus.com/embed.js');
    }

    function renderPagination() {
        if (options.posts.length <= options.pagination.postsPerPage) return;

        Kensei.DOM.renderString(options.container, '<div id="pagination"></div>');
        ...
        for (; i <= pages; i++) {
            Kensei.DOM.renderString(options.container, '<a href="/?page='+ i +'">' + i + '</a>');
        }
    }
